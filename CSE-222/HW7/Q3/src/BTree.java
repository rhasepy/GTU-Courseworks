...
public class BTree<E extends Comparable<E>> implements SearchTree<E> {
  ...
  private BTree.Node<E> root =  null;

  private int order;

  private E newParent;

  private BTree.Node<E> newChild;
 ...
 return find(root, item);
  ...
  private E find(BTree.Node<E> node, E item) {
  ...
  private boolean insert(BTree.Node<E> root, E item) {
  ...
  private void insertIntoNode(BTree.Node<E> node, int index, E item, BTree.Node<E> child) {
 ...
 return root.data[0];
  ...
  private void preOrderTraverse(BTree.Node<E> node, int d, StringBuilder sb) {
