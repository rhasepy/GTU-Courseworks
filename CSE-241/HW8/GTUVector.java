/**
* GTUVector generic class extended GTUContainer Abstract class
...
public class GTUVector<T> extends GTUContainer<T>
{
	...
	*/
	...
	public GTUVector(int size, T... virtualParam)
	{
	...
	private class GTUVectorIterator implements GTUIterator<T>
	{
		private int index = 0;
